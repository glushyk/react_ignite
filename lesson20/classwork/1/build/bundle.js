...
/***/ function(module, exports, __webpack_require__) {
	...
	var Parrent = function (_React$Component) {
	  _inherits(Parrent, _React$Component);

	  function Parrent() {
	    _classCallCheck(this, Parrent);

	    return _possibleConstructorReturn(this, (Parrent.__proto__ || Object.getPrototypeOf(Parrent)).apply(this, arguments));
	  }

	  _createClass(Parrent, [{
	    key: 'render',
	...
	_reactDom2.default.render(_react2.default.createElement(
	  Parrent,
	  { text: 'hello from parrent' },
	  _react2.default.createElement(Children, { text: 'hello from child' })
