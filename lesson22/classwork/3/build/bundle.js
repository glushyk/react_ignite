...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pr = function (_React$Component) {
	    _inherits(Pr, _React$Component);

	    function Pr(props) {
	        _classCallCheck(this, Pr);

	        var _this = _possibleConstructorReturn(this, (Pr.__proto__ || Object.getPrototypeOf(Pr)).call(this, props));

	        _this.state = { isShow: false };

	        _this.hendler = _this.hendler.bind(_this);
	        return _this;
	    }

	    _createClass(Pr, [{
	        key: 'hendler',
	        value: function hendler() {
	        ...
	        value: function render() {
	            ...
	            if (this.state.isShow) {
	                ...
	                for (var key in this.props) {
	                    keys.push(key);
	                }var propsList = keys.map(function (prop, id) {
	...
	ReactDOM.render(React.createElement(Pr, { prop1: 'something', prop2: 'test' }), document.getElementById('result'));
