...
/***/ function(module, exports, __webpack_require__) {
	...
	var Counter = React.createClass({
	    ...
	    hendlerVal1: function hendlerVal1(e) {
	        this.setState({ val1: e.target.value });
	    },
	    hendlerVal2: function hendlerVal2(e) {
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            null,
	            React.createElement('input', { type: 'number', value: this.state.val1, onChange: this.hendlerVal1, placeholder: '1' }),
	            React.createElement('input', { type: 'number', value: this.state.val2, onChange: this.hendlerVal2, placeholder: '2' }),
	            React.createElement(
	                'button',
	                { onClick: this.add },
	                '+'
