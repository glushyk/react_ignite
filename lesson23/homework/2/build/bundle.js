...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_logic.UserList, { users: _data2.default }), document.getElementById('result'));
	    ...
	    value: function render() {
	      var users = this.props.users.map(function (user, i) {
	        return _react2.default.createElement(
	          'tr',
	          { key: i },
	          _react2.default.createElement(Todouser, { user: user })
	        );
	      });
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          _react2.default.createElement(NewUser, { addEvent: this.addEvent })
	        )
	      );
	    }
	  }, {
	    key: 'addEvent',
	    value: function addEvent(todouser) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.NewUser = exports.Todouser = exports.UserList = undefined;
	...
	var UserList = function (_React$Component) {
	  ...
	  function UserList(props) {
	    ...
	    _this.state = { usersAll: _data2.default };
	    _this.addEvent = _this.addEvent.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(UserList, [{
	    ...
	    key: 'addEvent',
	    value: function addEvent(todouser) {
	      _data2.default.push(todouser.newuser);
	      this.setState({ usersAll: _data2.default });
	    }
	  }]);
	...
	var Todouser = function (_React$Component2) {
	  _inherits(Todouser, _React$Component2);

	  function Todouser() {
	    _classCallCheck(this, Todouser);

	    return _possibleConstructorReturn(this, (Todouser.__proto__ || Object.getPrototypeOf(Todouser)).apply(this, arguments));
	  }

	  _createClass(Todouser, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'td',
	...
	var NewUser = function (_React$Component3) {
	  _inherits(NewUser, _React$Component3);

	  function NewUser(props) {
	    _classCallCheck(this, NewUser);

	    var _this3 = _possibleConstructorReturn(this, (NewUser.__proto__ || Object.getPrototypeOf(NewUser)).call(this, props));
	  ...
	  _createClass(NewUser, [{
	    ...
	    value: function onSubmit(event) {
	      event.preventDefault();
	      var input = _reactDom2.default.findDOMNode(this.refs.userName);
	      var newuser = input.value;
	      this.props.addEvent({ newuser: newuser });
	      input.value = '';
	    }
	  }]);
